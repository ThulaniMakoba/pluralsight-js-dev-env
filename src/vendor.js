/* This file contains references to the vendor libraries
  ...
  one of them change. So basically, this voids customers having to
  download a huge JS file anytime a line of code changes. They only
  have to download vendor.js when a vendor library changes which should
  be less frequent. Any files that aren't referenced here will be bundled
